    ...
    >
      <div class="relative w-24 h-24 mb-8">
        <div class="absolute inset-0 flex items-center justify-center">
          <img :src="LogoSquare" alt="Yuna Logo" class="w-12 h-12 animate-bounce object-contain" />
        </div>
      </div>
                ...
                >
                  ...
                  >
                    <span
                      ...
                      >{{
                        userProfile.isLoggedIn ? userProfile.username : "Guest"
                      }}</span
                    >
                    <span
              ...
              >
                ...
                <template v-else>
                  <div class="flex flex-col items-center justify-center py-4">
                    ...
                    <h3 class="font-bold text-lg text-[var(--text-main)] mb-1">
                      欢迎访问
                    </h3>
                    <p
